...
<body style="color: var(--blue);background: var(--gray-dark);">
    ...
    <br>
    <h1 style="border-right-style: none;text-align: center;color: white;" class="fw-bold">CONTENIDO DIVERSO</h1>
    ...
    <?php 
        ...
        $miconsulta = "SELECT * FROM `contenido` WHERE 'otros' = categoria ORDER BY FECHA DESC";
