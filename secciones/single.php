    ...
    while($row = mysqli_fetch_assoc($result)){
        if($row['Imagen']!=""){
                ...
                <div class='container'>
                    ...
                    <div class='container' style=' width: 300px; position: relative; left: 390px;'>
                        <p class='text-right' style='background: white; padding-top: 10px; padding-bottom: 10px; padding-right: 10px; width: 300px; border-top-left-radius: 15px; border-bottom-left-radius: 15px;'>Publicado el " . substr($row['Fecha'], 0, 10) . " a las " . substr($row['Fecha'], 10, 18) . "<p>
                    </div>
                    <p class='text-justify' style='background: white; padding-top: 15px; padding-bottom: 15px; padding-right: 10px; padding-left: 10px;'>". $row['Comentario'] . "</p>
                </div>
