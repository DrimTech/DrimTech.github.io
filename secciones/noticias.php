...
<?php 
    ...
    $miconsulta = "SELECT * FROM `contenido` WHERE 'noticias' = categoria ORDER BY FECHA DESC"; # Esta consulta ordena la página para que se muestre por categoría y fecha más reciente de publicación
